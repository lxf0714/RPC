...
inline void Resultcode::set_errcode(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:fixbug.Resultcode.errcode)
}
inline void Resultcode::set_errcode(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:fixbug.Resultcode.errcode)
}
inline void Resultcode::set_errcode(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:fixbug.Resultcode.errcode)
}
